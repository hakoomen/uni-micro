...
; 0000 0021 {
	...
	.CSEG
_countSevenSegment:
; .FSTART _countSevenSegment
; 0000 0022   for (i = from; i <= to && i < sizeof(sevenSegmentNumberCodes) / sizeof(int); i++)
	ST   -Y,R27
	ST   -Y,R26
;	from -> Y+2
;	to -> Y+0
...
_0x8:
; 0000 0023   {
; 0000 0024     PORTC = sevenSegmentNumberCodes[i];
	MOVW R30,R4
	LDI  R26,LOW(_sevenSegmentNumberCodes)
	LDI  R27,HIGH(_sevenSegmentNumberCodes)
	LSL  R30
	ROL  R31
	ADD  R26,R30
	ADC  R27,R31
...
; 0000 003B DDRC=(1<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(255)
	OUT  0x14,R30
...
_0x9:
; 0000 0093       {
; 0000 0094              countSevenSegment(0, 9);
	LDI  R30,LOW(0)
	LDI  R31,HIGH(0)
	ST   -Y,R31
	ST   -Y,R30
